...
| **Redo** | Ctrl + Y |
| **Delete** | Delete |
| **Clear model** | Ctrl + Shift + Delete |

### Selection

| Action | Shortcut |
| ------ | -------- |
| **Select cursor tool / cancel current tool** | Esc |
| **Last used tool** | Spacebar |
...
| **Toggle groups selection** | Ctrl + 5 |
