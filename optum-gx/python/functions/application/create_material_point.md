...
<dd>Drainage condition ('drained', 'undrained'). sx0, sy0, sz0, sxy0, syz0, szx0 : float Initial stresses [kPa]. sx, sy, sz, sxy, syz, szx : float Multiplier stresses [kPa]. supportSx, supportSy, supportSz, supportSxy, supportSyz, supportSzx : bool|str Stress supports ('true'/'false').</dd>
</dl>
