...
<dt>color : Color</dt>
<dd>Material appearance. color= rgb(195,105,54)</dd>
<dt>Eu : float</dt>
...
TrescaMaterial = prj.Tresca(name='Tresca Soil',
color= Color(r=195,g=105,b=54),
Eu = 30,
cu = 30,
gamma_dry= 18,
gamma_sat= 20,
...
model2d.set_solid(shapes=Face,material=TrescaMaterial)
```
