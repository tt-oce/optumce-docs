...
<dt>color : Color</dt>
<dd>Material appearance. color= rgb(108,136,160)</dd>
<dt>drainage : str</dt>
...
RigidMaterial = prj.Rigid(name='RigidMaterial',
color= Color(r=108,g=136,b=160),
...
model2d.set_solid(shapes=Face,material=RigidMaterial)
```
