...
Define a Drucker-Prager material.
...
<dt>k : float</dt>
<dd>Model parameter,in kPa</dd>
<dt>M : float</dt>
<dd>Model fitting parameter</dd>
<dt>flow_rule : str</dt>
<dd>flow_rule = 'associated' or 'nonassociated'</dd>
<dt>N : float</dt>
<dd>Model cap parameter</dd>
...
DruckerPragerMaterial = prj.DruckerPrager(name='DruckerPragerMaterial',
color=Color(r=139,g=131,b=166),
...
model2d.set_solid(shapes=Face,material=DruckerPragerMaterial)
```
