...
<dt>OCR : float</dt>
<dd>Over consolidation ratio.</dd>
<dt>K0 : float</dt>
<dd>Earth pressure coefficient at rest.</dd>
<dt>e0 : float</dt>
<dd>Initial void ratio.</dd>
<dt>creep : str</dt>
<dd>Enable creep. creep = 'yes' or 'no'</dd>
<dt>relative_creep_index : float</dt>
<dd>Creep index relative to compression index.</dd>
