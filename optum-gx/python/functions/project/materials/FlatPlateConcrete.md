...
<dt>m_px_plus : float</dt>
<dd>Positive bending moment capacity in x, in kNm/m.</dd>
<dt>m_py_plus : float</dt>
<dd>Positive bending moment capacity in y, in kNm/m.</dd>
<dt>m_px_minus : float</dt>
<dd>Negative bending moment capacity in x, in kNm/m.</dd>
<dt>m_py_minus : float</dt>
<dd>Negative bending moment capacity in y, in kNm/m.</dd>
<dt>f_c : float</dt>
