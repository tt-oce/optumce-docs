...
* Tools for model generation and result extraction
...
---
<!--
## 🖼️ Suggested Visuals (to add in site)
-->
<!--
1. Hero graphic:
   Python Script → GX Model → Analysis → Results

2. Side-by-side:
   Code snippet vs rendered GX model

3. Icons for:
   Automation / Parametric / Integration / Plugins
-->
