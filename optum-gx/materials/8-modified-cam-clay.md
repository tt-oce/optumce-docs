...
- **OCR**: overconsolidation ratio (see [Section 8.3](#83-initial-stresses-and-overconsolidation-ratio))
...
where $\mathbb{C}^e$ is given in the [Elasticity](/materials/2-elasticity) section.
