...
respectively.\
Some possible depictions of the MC failure surface are shown in [Figure 5.1](/optum-gx/materials/5-tresca).
...
deviatoric strain $\varepsilon_{q,cr}$ (see [Notation](/optum-gx/materials/1-notation) for exact definition of these strains).

![Softening Mohr-Coulomb material in triaxial
compression.](mc_softning.eps){#mc_softening width="68%"}
